...
public class CapitalGameFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        gameTitlePage.setText("Q" + (questionNo) + "." + " What is the capital city of this country?");
        ...
        for (Button b : buttonsForGame) {
            b.setText(selectedCountries.get(choice).getCapital());
            ...
            if (choice == 0) { // correct answer
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        resultsAnswer.setText("This correct answer is " + selectedCountries.get(0).getCapital() + ".");
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        resultsAnswer.setText("This is " + selectedCountries.get(0).getCapital());
